    ...
    describe("authenticateUser", () => {
        ...
        it("throw, if client was not found", async () => {
            ...
            try {
                ...
                assert.equal(error.message, "Could not find client with id 'dummyClient'.");
            }
        });
        ...
        it("throw, if redirect uris do not match", async () => {
            ...
            try {
                ...
                assert.equal(error.message, "Redirect URI 'http://localhost/invalid' is not valid for client with id 'dummyClient'.");
            }
        });
    });
});
